                                        ...
                                        <tbody>
                                            <tr
                                                ...
                                                <td style="font-family:Roboto,Oxygen,Ubuntu,Cantarell,'Fira Sans','Droid Sans','Helvetica Neue',sans-serif;box-sizing:border-box;font-size:12px;vertical-align:top;color:#888;margin:0"
                                                    valign="top">
                                                    <div><span class="il"STC KIET</span></div><a href="mailto:dsckiet@gmail.com"
                                                        ...
                                                        target="_blank"
                                                        data-saferedirecturl="https://www.google.com/url?q=mailto:stckiet@kiet.edu">Drop
                                                        us a query</a>
                                                </td>
                                            </tr>
                                        </tbody>
...
module.exports.getMailTemplate = (data, type) =>{
    let templates={
        "reset-pwd-link": {
			subject: "Password reset request | STC KIET",
			html: getFullHTML(
				`Someone (hopefully you) has requested a password reset for
                this account on STC KIET Portal. Here is the reset
